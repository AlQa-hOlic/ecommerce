            ...
            {status === "loading" || status === "unauthenticated" ? (
              ...
              <>
                <Menu as="div" className="relative group">
                  {({ open }) => (
                    <>
                      <Menu.Button className="rounded-full text-gray-400 hover:text-gray-600 focus:text-gray-600 group-focus-within:text-gray-600 focus:outline-none transition-colors duration-150 ease-linear">
                        <span className="sr-only">My Account</span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-6 w-6"
                      ...
                      >
                        ...
                        >
                          <Menu.Item
                            as="li"
                            disabled
                            className="p-2 text-gray-400 cursor-default select-none whitespace-nowrap text-ellipsis overflow-hidden"
                          >
                            Signed in as{" "}
